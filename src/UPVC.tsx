...
// ─── Window Types ─────────────────────────────────────────────────────────────
const WINDOW_TYPES = [
  { num: '01', title: 'Sliding Windows', desc: 'Sleek and space-saving — sliding windows provide smooth operation and modern aesthetics for any room.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB3pBe9jBFlkTEdFU2gFCqYYZqyhCQ7jahlbJH1vCC9pjTFsPbUFft2mPKx_6ArATke7P3ar8YCFWcjR1SKONNb4HCFp0CXGKtDD-P6vIl8bU40eTTMcICvs4eUGF3sx7uhJXc6Tn-T3aoMevSxcIkahhFxdin3C5E6BWnfeI87H1tMJl3Zt4viRzp1KUXh3m4zfHz5HpBOycAJB4KSrN12uWmQecLiRiZWcM3jQX1VDBFj_ep1Ffx7GH0B1s3TBh-tJsz3mcvYxdc', overview: 'Glide horizontally on tracks requiring no swing space. Available in 2-track and 3-track configurations with wind resistance up to 2 kPa.', features: ['2-track & 3-track configurations', 'Wind resistance up to 2 kPa', 'Smooth stainless steel rollers', 'Anti-lift security locks', 'Glazing up to 11 mm', 'Max size 2.2 m × 2.1 m'], applications: ['Apartments & high-rises', 'Commercial buildings', 'Industrial facilities'] },
  { num: '02', title: 'Casement Windows', desc: 'Reliable, energy-efficient, and versatile — casement windows offer maximum ventilation and superior security.', img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80', overview: 'Hinged at the side and opening outward like a door, casement windows provide excellent ventilation, unobstructed views, and a tight seal when closed.', features: ['Maximum ventilation with full opening', 'Multi-point locking for superior security', 'Excellent thermal and acoustic insulation', 'Available in single and double sash', 'Easy to clean from inside', 'Compatible with mosquito mesh'], applications: ['Residential bedrooms & living rooms', 'Commercial offices', 'Schools & institutions'] },
  ...
  { num: '04', title: 'Combination Windows', desc: 'Versatile combination systems that blend fixed, sliding, and casement panels into one seamless unit.', img: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80', overview: 'Combination windows merge multiple window types — fixed, operable, and ventilator — into a single frame system, maximising light, ventilation, and design flexibility.', features: ['Mix of fixed and operable panels', 'Custom configurations available', 'Seamless frame joining', 'Maximises natural light', 'Suitable for large openings', 'Available in all profile systems'], applications: ['Living rooms & lobbies', 'Commercial facades', 'Institutional buildings'] },
  { num: '05', title: 'Tilt and Turn Windows', desc: "Innovative and flexible — tilt-and-turn windows offer easy ventilation control and enhanced security.", img: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=600&q=80', overview: "Two opening modes with a single handle — tilt inward from the top for secure ventilation, or turn fully open like a casement. Ideal for high-rise buildings.", features: ['Two opening modes with one handle', 'Tilt mode for secure ventilation', 'Turn mode for full access & cleaning', 'Child-safe ventilation position', 'Excellent burglar resistance', 'Ideal for high-rise buildings'], applications: ['High-rise apartments', 'Hotels & serviced apartments', 'Healthcare facilities'] },
  { num: '06', title: 'Villa Windows', desc: 'Premium large-format uPVC windows designed for villas and luxury residences demanding elegance and performance.', img: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80', overview: 'Villa windows are large-format, high-performance uPVC systems designed for premium residences. They combine expansive glass areas with robust profiles for maximum light, views, and thermal comfort.', features: ['Large-format glass panels', 'Premium multi-point locking', 'Superior thermal & acoustic performance', 'Floor-to-ceiling options available', 'Available in all lamination finishes', 'Custom sizes for any opening'], applications: ['Luxury villas & bungalows', 'Premium residential projects', 'Resort & hospitality buildings'] },
];
