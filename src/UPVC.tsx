...
// ─── Window Types ─────────────────────────────────────────────────────────────
const WINDOW_TYPES = [
  { num: '01', title: 'uPVC Casement Windows', desc: 'Reliable, energy-efficient, and versatile — casement windows offer maximum ventilation and superior security.', img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80', overview: 'Hinged at the side and opening outward like a door, casement windows provide excellent ventilation, unobstructed views, and a tight seal when closed.', features: ['Maximum ventilation with full opening', 'Multi-point locking for superior security', 'Excellent thermal and acoustic insulation', 'Available in single and double sash', 'Easy to clean from inside', 'Compatible with mosquito mesh'], applications: ['Residential bedrooms & living rooms', 'Commercial offices', 'Schools & institutions'] },
  { num: '02', title: 'uPVC French Windows', desc: "Elegant and timeless — French windows bring natural light and a classic touch to your home's design.", img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', overview: 'Two full-length glass panels opening from the centre, creating a wide elegant opening that floods interiors with natural light.', features: ['Double-leaf opening for wide access', 'Floor-to-ceiling glass options', 'Multi-point locking system', 'Weather-tight sealing gaskets', 'Available with transom & sidelights', 'Classic & modern design variants'], applications: ['Balconies & terraces', 'Living rooms', 'Hospitality & hotels'] },
  { num: '03', title: 'uPVC Sliding Windows', desc: 'Sleek and space-saving — sliding windows provide smooth operation and modern aesthetics for any room.', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB3pBe9jBFlkTEdFU2gFCqYYZqyhCQ7jahlbJH1vCC9pjTFsPbUFft2mPKx_6ArATke7P3ar8YCFWcjR1SKONNb4HCFp0CXGKtDD-P6vIl8bU40eTTMcICvs4eUGF3sx7uhJXc6Tn-T3aoMevSxcIkahhFxdin3C5E6BWnfeI87H1tMJl3Zt4viRzp1KUXh3m4zfHz5HpBOycAJB4KSrN12uWmQecLiRiZWcM3jQX1VDBFj_ep1Ffx7GH0B1s3TBh-tJsz3mcvYxdc', overview: 'Glide horizontally on tracks requiring no swing space. Available in 2-track and 3-track configurations with wind resistance up to 2 kPa.', features: ['2-track & 3-track configurations', 'Wind resistance up to 2 kPa', 'Smooth stainless steel rollers', 'Anti-lift security locks', 'Glazing up to 11 mm', 'Max size 2.2 m × 2.1 m'], applications: ['Apartments & high-rises', 'Commercial buildings', 'Industrial facilities'] },
  { num: '04', title: 'uPVC Fixed Windows', desc: 'Perfect for framing views — fixed windows provide natural light and modern aesthetic without compromising insulation.', img: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80', overview: 'Non-operable windows designed purely for light and views. No moving parts means the best thermal and acoustic performance.', features: ['Maximum glass area for light & views', 'Superior thermal insulation', 'No moving parts — zero maintenance', 'Supports large glazing sizes', 'Can be combined with operable units', 'Ideal for curtain wall systems'], applications: ['Office facades', 'Stairwells & corridors', 'Showrooms & retail'] },
  { num: '05', title: 'uPVC Bay Windows', desc: 'Add elegance and extra space to your home with our stylish and functional bay windows.', img: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80', overview: 'Project outward from the main wall, creating a recessed area inside that dramatically increases natural light and adds architectural character.', features: ['Projects outward for extra interior space', 'Three-panel angled configuration', 'Panoramic views from multiple angles', 'Creates natural window seat area', 'Available in 90° and 135° angles', 'Custom sizes available'], applications: ['Residential living rooms', 'Master bedrooms', 'Dining areas'] },
  { num: '06', title: "uPVC Tilt 'n' Turn Windows", desc: "Innovative and flexible — tilt-and-turn windows offer easy ventilation control and enhanced security.", img: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=600&q=80', overview: "Two opening modes with a single handle — tilt inward from the top for secure ventilation, or turn fully open like a casement. Ideal for high-rise buildings.", features: ['Two opening modes with one handle', 'Tilt mode for secure ventilation', 'Turn mode for full access & cleaning', 'Child-safe ventilation position', 'Excellent burglar resistance', 'Ideal for high-rise buildings'], applications: ['High-rise apartments', 'Hotels & serviced apartments', 'Healthcare facilities'] },
  { num: '07', title: 'uPVC Arched Windows', desc: "Elevate your home's aesthetic with beautifully designed arch windows that bring timeless charm.", img: 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=600&q=80', overview: 'Curved top adds elegance and grandeur to any facade. Available as fixed or with operable lower sections in any radius.', features: ['Custom arch profiles to any radius', 'Fixed or operable lower section', 'Seamless curved uPVC extrusion', 'Matches standard window systems', 'Available in all lamination finishes', 'Adds architectural character'], applications: ['Heritage & luxury residences', 'Churches & institutions', 'Premium commercial buildings'] },
  { num: '08', title: 'uPVC Awning Windows', desc: 'Ideal for ventilation — awning windows offer protection from rain while allowing fresh air.', img: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=600&q=80', overview: 'Hinged at the top and opening outward from the bottom. Can remain open during light rain, providing continuous ventilation without water ingress.', features: ['Opens outward from bottom', 'Ventilation even during rain', 'Top-hinged for water deflection', 'Compact design for small openings', 'Can be stacked with fixed panels', 'Friction stay for position control'], applications: ['Bathrooms & kitchens', 'Basements & low openings', 'Combined with fixed windows'] },
  { num: '09', title: 'uPVC Ventilator Windows', desc: 'Ensure continuous airflow with our durable and efficient ventilators designed for modern homes.', img: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&q=80', overview: 'Compact purpose-built units for continuous background ventilation. Integrate seamlessly into walls or above doors and windows.', features: ['Continuous background ventilation', 'Compact & discreet design', 'Insect mesh as standard', 'Adjustable airflow control', 'Integrates with wall or frame', 'Low maintenance uPVC construction'], applications: ['Kitchens & bathrooms', 'Above doors & windows', 'Commercial & industrial spaces'] },
];
